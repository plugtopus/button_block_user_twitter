(function (e, t) {
    ...
    function O(e, t, n) {
        for (var r, i = (qt[t] || []).concat(qt["*"]), o = 0, s = i.length; s > o; o++)
        ...
        function (e, t) {
            ...
            S = n.isXML = function (e) {
                ...
                var n = e ? e.ownerDocument || e : $,
                    r = n.defaultView;
                return n !== q && 9 === n.nodeType && n.documentElement ? (q = n, H = n.documentElement, O = !S(n), r && r.attachEvent && r !== r.top && r.attachEvent("onbeforeunload", function () {
                    L()
                ...
                }, P = [], F = [], (C.qsa = ve.test(n.querySelectorAll)) && (o(function (e) {
                    ...
                    t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("t", ""), e.querySelectorAll("[t^='']").length && F.push("[*^$]=" + ie + "*(?:''|\"\")"), e.querySelectorAll(":enabled").length || F.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), F.push(",.*:")
                ...
                }), F = F.length && RegExp(F.join("|")), P = P.length && RegExp(P.join("|")), M = ve.test(H.contains) || H.compareDocumentPosition ? function (e, t) {
                    ...
                    return r ? 1 & r || !C.sortDetached && t.compareDocumentPosition(e) === r ? e === n || M($, e) ? -1 : t === n || M($, t) ? 1 : A ? ne.call(A, e) - ne.call(A, t) : 0 : 4 & r ? -1 : 1 : e.compareDocumentPosition ? -1 : 1
                } : function (e, t) {
                    var r, i = 0,
                        o = e.parentNode,
                        s = t.parentNode,
                        ...
                        l = [t];
                    if (e === t) return U = !0, 0;
                    if (!o || !s) return e === n ? -1 : t === n ? 1 : o ? -1 : s ? 1 : A ? ne.call(A, e) - ne.call(A, t) : 0;
                    if (o === s) return a(e, t);
                ...
                filter: {
                    ...
                    CLASS: function (e) {
                        var t = z[e + " "];
                        return t || (t = RegExp("(^|" + ie + ")" + e + "(" + ie + "|$)")) && z(e, function (e) {
    ...
    oe.Callbacks = function (e) {
        ...
        when: function (e) {
            ...
            if (s > 1)
                for (t = Array(s), n = Array(s), r = Array(s); s > i; i++) o[i] && oe.isFunction(o[i].promise) ? o[i].promise().done(l(i, r, o)).fail(u.reject).progress(l(i, n, t)) : --a;
        ...
        data: function (e, n) {
            ...
            if (e === t) {
                if (this.length && (u = ge.get(s), 1 === s.nodeType && !me.get(s, "hasDataAttrs"))) {
                    for (r = s.attributes; r.length > a; a++) i = r[a].name, 0 === i.indexOf("data-") && (i = oe.camelCase(i.slice(5)), o(s, i, u[i]));
    ...
    oe.fn.extend({
        ...
        val: function (e) {
            ...
            })) : o ? (n = oe.valHooks[o.type] || oe.valHooks[o.nodeName.toLowerCase()], n && "get" in n && (r = n.get(o, "value")) !== t ? r : (r = o.value, "string" == typeof r ? r.replace(Te, "") : null == r ? "" : r)) : void 0
        }
    }), oe.extend({
        valHooks: {
            option: {
        ...
        attr: function (e, n, r) {
            ...
            if (e && 3 !== s && 8 !== s && 2 !== s) return typeof e.getAttribute === z ? oe.prop(e, n, r) : (1 === s && oe.isXMLDoc(e) || (n = n.toLowerCase(), i = oe.attrHooks[n] || (oe.expr.match.bool.test(n) ? be : xe)), r === t ? i && "get" in i && null !== (o = i.get(e, n)) ? o : (o = oe.find.attr(e, n), null == o ? t : o) : null !== r ? i && "set" in i && (o = i.set(e, r, n)) !== t ? o : (e.setAttribute(n, r + ""), r) : (oe.removeAttr(e, n), t))
        },
            ...
            if (m && (u = m.events)) {
                for (t = (t || "").match(ae) || [""], l = t.length; l--;)
                    if (a = Se.exec(t[l]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d) {
                        for (f = oe.event.special[d] || {}, d = (r ? f.delegateType : f.bindType) || d, p = u[d] || [], a = a[2] && RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = p.length; o--;) c = p[o], !i && g !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || r && r !== c.selector && ("**" !== r || !c.selector) || (p.splice(o, 1), c.selector && p.delegateCount--, f.remove && f.remove.call(e, c));
    ...
    oe.fn.extend({
        ...
        style: function (e, n, r, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, s, a, u = oe.camelCase(n),
                    l = e.style;
                return n = oe.cssProps[u] || (oe.cssProps[u] = v(l, u)), a = oe.cssHooks[n] || oe.cssHooks[u], r === t ? a && "get" in a && (o = a.get(e, !1, i)) !== t ? o : l[n] : (s = typeof r, "string" === s && (o = Ve.exec(r)) && (r = (o[1] + 1) * o[2] + parseFloat(oe.css(e, n)), s = "number"), null == r || "number" === s && isNaN(r) || ("number" !== s || oe.cssNumber[u] || (r += "px"), oe.support.clearCloneStyle || "" !== r || 0 !== n.indexOf("background") || (l[n] = "inherit"), a && "set" in a && (r = a.set(e, r, i)) === t || (l[n] = r)), t)
            }
        },
        ...
        oe.cssHooks[n] = {
            get: function (e, r, i) {
                return r ? 0 === e.offsetWidth && _e.test(oe.css(e, "display")) ? oe.swap(e, Je, function () {
                    return N(e, n, i)
                }) : N(e, n, i) : t
            },
            set: function (e, t, r) {
                var i = r && b(e);
                return T(e, t, r ? C(e, n, r, oe.support.boxSizing && "border-box" === oe.css(e, "boxSizing", !1, i), i) : 0)
            }
        }
    }), oe(function () {
        oe.support.reliableMarginRight || (oe.cssHooks.marginRight = {
            ...
            oe.cssHooks[n] = {
                get: function (e, r) {
                    return r ? (r = Ie(e, n), Ye.test(r) ? oe(e).position()[n] + "px" : r) : t
                }
            }
        })
    ...
    oe.ajaxSetup({
        ...
        return u || "jsonp" === n.dataTypes[0] ? (o = n.jsonpCallback = oe.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback, u ? n[u] = n[u].replace(wt, "$1" + o) : n.jsonp !== !1 && (n.url += (ut.test(n.url) ? "&" : "?") + n.jsonp + "=" + o), n.converters["script json"] = function () {
    ...
    e.ActiveXObject && oe(e).on("unload", function () {
        ...
        return oe.support.cors || Tt && !e.crossDomain ? {
            send: function (r, i) {
                ...
                n = function (e) {
                    return function () {
                        n && (delete kt[s], n = a.onload = a.onerror = null, "abort" === e ? a.abort() : "error" === e ? i(a.status || 404, a.statusText) : i(Ct[a.status] || a.status, a.statusText, "string" == typeof a.responseText ? {
                            text: a.responseText
        ...
        qt = {
            "*": [function (e, t) {
                var n = this.createTween(e, t),
                    ...
                    s = (oe.cssNumber[e] || "px" !== o && +r) && Dt.exec(oe.css(n.elem, e)),
                    a = 1,
                    u = 20;
                if (s && s[3] !== o) {
                    o = o || s[3], i = i || [], s = +r || 1;
    ...
    oe.Animation = oe.extend(F, {
        ...
        var e, n = oe.timers,
            r = 0;
        for (Et = oe.now(); n.length > r; r++) e = n[r], e() || n[r] !== e || n.splice(r--, 1);
        ...
        var n, r, i = this[0],
            ...
            s = i && i.ownerDocument;
        return s ? (n = s.documentElement, oe.contains(n, i) ? (typeof i.getBoundingClientRect !== z && (o = i.getBoundingClientRect()), r = $(s), {
